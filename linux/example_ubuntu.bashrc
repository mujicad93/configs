...
export HISTIGNORE="ls:ll:lt:cd:pwd:bg:fg:history:cdi:cdf:cdp:gl:gs:git push:srcrc:git commit:ga:git mrg:gb:git stash:git pop::git add -p:lumvpn:fb:git push --force"
...
source ~/configs/linux/linux.bashrc
